...
class MergeRecipe():
    ...
    def run_merge(self, index, skip_merge_if_exists, config_source, save_metadata):
        ...
        try:
            ...
            results = extras.run_modelmerger(id_task, self.A, self.B, self.C, self.S, self.M, self.F, self.O, self.CF, config_source, bake_in_vae, discard_weights, save_metadata, add_merge_recipe, copy_metadata_fields, metadata_json)
